...
PhysVehicle3D* ModulePhysics3D::AddVehicle(const VehicleInfo& info)
{
	...
	btCollisionShape* colShape = new btBoxShape(btVector3(info.chassis_size.x*0.75f, info.chassis_size.y*0.5f, info.chassis_size.z*1.06f));
	shapes.add(colShape);

	btTransform trans;
	trans.setIdentity();
	trans.setOrigin(btVector3(info.chassis_offset.x, info.chassis_offset.y, info.chassis_offset.z + 1.27));
